...
// ─── Evidence placeholder (FE-6) ─────────────────────────────────────────────
function EvidencePlaceholder() {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center space-y-2">
      <p className="text-sm text-secondary">Evidence management is available in the Evidence module.</p>
      <p className="text-xs text-muted">Navigate to the Acquisition tab on the Overview to manage evidence items.</p>
    </div>
  );
}

// ─── Reports placeholder (FE-6) ──────────────────────────────────────────────
function ReportsPlaceholder() {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center space-y-2">
      <p className="text-sm text-secondary">Report generation is available when an investigation is complete.</p>
      <p className="text-xs text-muted">Reports are generated by the backend when all analysis stages finish.</p>
    </div>
  );
}
