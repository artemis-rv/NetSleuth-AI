...
class TestM2Adapter(unittest.TestCase):
    def setUp(self):
        ...
        m2_fixture_path = Path(__file__).resolve().parent.parent.parent.parent / "fixtures" / "findings" / "finding-v1-scenario-001.json"
    ...
    def test_integration_with_m1_context(self):
        m1_fixture_path = Path(__file__).resolve().parent.parent.parent.parent / "fixtures" / "network_intelligence" / "network-intelligence-v1-m1-phase1.json"
